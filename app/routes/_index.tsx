      ...
      <div className="absolute inset-0">
        ...
        <div className=" absolute inset-0 flex h-full items-end justify-start">
          <div className="mb-10 text-white text-left max-w-5xl px-4">
            <h3 className=" mb-4 bg-white text-black w-fit px-4 py-2 rounded-full shadow-2xl">
        ...
        <div className="absolute inset-0 flex h-full items-end justify-end">
          <div className="mb-10 text-white max-w-5xl px-4">
            <div className="flex gap-5 items-center">
              <img src={currentPost.profileImage} alt={currentPost.profileName} className="w-8 h-8 rounded-full object-cover shadow-md"/>
              <h2 className="font-semibold text-xl">{currentPost.profileName}</h2>
            </div>
